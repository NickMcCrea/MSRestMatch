...
public class TrainingRoomMain : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //simulation.CreateDummyTank(GenerateRandomHexColorString(), "DummyTank1", new Vector3(0, 0, 20), true, true);
        //simulation.CreateDummyTank(GenerateRandomHexColorString(), "DummyTank2", new Vector3(0, 0, -20), true, true);
